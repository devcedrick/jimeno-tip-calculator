...
const Input = ({placeholder, imgSrc, allowFloatingNum}: InputProps) => {
  ...
  return (
    <div className={`flex flex-row items-center bg-gray-200 w-[80%] h-12 text-xl lg:text-2xl rounded-md px-5 text-right font-semibold text-(--secondary-color) ${isFocused ? 'input-focus' : ''}`}>
