...
const ResultPanel = () => {
  return (
    <div className='flex flex-col justify-between bg-(--secondary-color) h-full md:w-full lg:w-max p-8 rounded-xl gap-10 max-lg:min-w-[300px]'>
      <div className='flex flex-col gap-5 lg:gap-10'>
        <div className='flex items-center justify-between gap-15 lg:gap-25'>
          <div className='w-max'>
