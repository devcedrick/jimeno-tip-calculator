  ...
  return (
    <div className='flex flex-col justify-between gap-8 max-sm:w-full w-max h-max p-2 lg:p-5 '>
      <div>
        ...
        <Input placeholder="0" imgSrc="/images/icon-dollar.svg" allowFloatingNum={true} allowZero={true} />
      </div>
      <TipLayout/>
      <div>
        <p className='input-label mb-2'>Number of People</p>
        <Input placeholder="0" imgSrc="/images/icon-person.svg" allowFloatingNum={false} allowZero={false} />
      </div>
    </div>
  )
}
